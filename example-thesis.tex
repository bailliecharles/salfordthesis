...
\documentclass[tgheros,headers,manuscript,12pt]{salford}
...
%\usepackage{url}
\PassOptionsToPackage{hyphens,spaces,obeyspaces}{url}\usepackage{url}
...
\usepackage{colortbl} %coloured tables http://latexcolor.com/

\usepackage[final]{pdfpages}

%\usepackage{setspace} %not loaded by memoir
